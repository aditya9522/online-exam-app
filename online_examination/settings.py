...
SECRET_KEY = 'django-insecure-syp(9y4fo0j$9d0!9&mkjiy1drj1&9cp30#rro+-4yai%78&xd'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['127.0.0.1', 'localhost', '*', '2d92-2402-8100-26f1-eca6-f9ca-1aa3-4b5-312b.ngrok-free.app']
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
DEFAULT_FROM_EMAIL = 'Exam Coordinator'
